...
if st.button("🚀 Process Video", type="primary"):
    if not youtube_url:
        ...
        try:
            ...
            # ⚠️ FIX: ALL FORMATS & LONG VIDEOS SUPPORT ⚠️
            ydl_opts = {
                'quiet': True, 
                ...
                'format': 'best',                  # हर तरह के वीडियो फॉर्मेट को सपोर्ट करेगा
                'format_sort': ['res', 'ext:mp4:m4a'],
                'skip_download': True,             # बिना डाउनलोड किए तुरंत डेटा निकालेगा
                'cachedir': False
            }
            ...
            status_box.update(label="कंट्री प्रतिबंध!", state="error")
            st.error("❌ यह वीडियो इस रीजन/सर्वर लोकेशन पर उपलब्ध नहीं है। कृपया कोई दूसरा YouTube वीडियो लिंक आज़माएं।")
