...
import yt_dlp
from yt_dlp.networking.impersonate import ImpersonateTarget  # 🚨 LATEST ADDITION (मुखौटा)
...
if st.button("🚀 Process Video", type="primary"):
    if not youtube_url:
        ...
        try:
            ...
            # ⚠️ LATEST ANTI-BLOCK SETTINGS (सही मुखौटे के साथ) ⚠️
            ydl_opts = {
                'quiet': True, 
                ...
                'extractor_retries': 3,  
                'socket_timeout': 30,    
                'impersonate': ImpersonateTarget(client='chrome'), # 🚨 यहाँ फिक्स किया गया है
                'cachedir': False
            }
